...
| Document | Description | Last Modified |
| -------- | ----------- | ------------- |
| [Template System Overview](./templates/index.md) | The doit template system provides a structured workflow for development... | 2026-04-20 |
| [Agent Skills Format](./templates/agent-skills.md) | Current Claude Code template layout (0.2.0+) — `.claude/skills/doit.<name>/SKILL.md`... | 2026-04-20 |
| [Copilot Prompt Files](./templates/copilot-prompts.md) | Native VS Code `.prompt.md` schema generated by `doit sync-prompts --agent copilot`... | 2026-04-20 |
| [Command Templates (Legacy)](./templates/commands.md) | Back-compat workflow reference for flat `.claude/commands/` files... | 2026-04-20 |
...
| [JSON Schemas](./templates/schemas.md) | Bundled JSON Schema contracts (constitution frontmatter)... | 2026-04-20 |
