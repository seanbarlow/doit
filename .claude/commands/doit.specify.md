...
The text the user typed after `/doit.specify` in the triggering message **is** the feature description. Assume you always have it available in this conversation even if `$ARGUMENTS` appears literally below. Do not ask the user to repeat it unless they provided an empty command.
...
4. **Skip Flag Option**:
   ...
   - Example: `/doit.specify "my feature" --skip-issues`
