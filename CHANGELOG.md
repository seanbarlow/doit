...
- All command files now prefixed with `speckit.` (e.g., `speckit.doit.md`, `speckit.plan.md`) for better discoverability and differentiation in IDE/CLI command palettes and file explorers
