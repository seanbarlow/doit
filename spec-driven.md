...
/doit.doit Real-time chat system with message history and user presence
...
/doit.planit WebSocket for real-time messaging, PostgreSQL for history, Redis for presence
