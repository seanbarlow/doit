...
| FR-003 | The plan-template.md MUST reference `.claude/commands/doit.plan.md` | Done |
...
| FR-006 | The doit.specify.md command MUST NOT reference `/doit.clarify` | Done |
...
2. Replaced `/doit.clarify` with `/doit.plan` in doit.specify.md
3. Fixed path reference from `.specify/templates/commands/plan.md` to `.claude/commands/doit.plan.md`
...
| `.specify/templates/plan-template.md` | Fixed path to `.claude/commands/doit.plan.md` |
| `.claude/commands/doit.specify.md` | Removed `/doit.clarify` references |
